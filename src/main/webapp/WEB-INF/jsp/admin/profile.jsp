    ...
    <div class="content">
        ...
        <div class="profile-container">
            <div class="profile-card">
                ...
                <div class="profile-name"><c:out value="${admin.name}"/></div>
                <div class="profile-username">@<c:out value="${admin.username}"/></div>
                <div class="profile-info">
                    <div class="profile-info-item">
                        <span class="profile-info-label">用户名</span>
                        <span class="profile-info-value"><c:out value="${admin.username}"/></span>
                    </div>
                    <div class="profile-info-item">
                        <span class="profile-info-label">姓名</span>
                        <span class="profile-info-value"><c:out value="${admin.name}"/></span>
                    </div>
                    <div class="profile-info-item">
                        <span class="profile-info-label">联系电话</span>
                        <span class="profile-info-value"><c:out value="${admin.phone}"/></span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <form id="profileForm" action="${pageContext.request.contextPath}/admin/profile" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="username" name="username" class="form-control" value="${fn:escapeXml(admin.username)}" required placeholder="请输入用户名">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group">
                            <label for="name">姓名</label>
                            <input type="text" id="name" name="name" class="form-control" value="${fn:escapeXml(admin.name)}" required placeholder="请输入姓名">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="phone" name="phone" class="form-control" value="${fn:escapeXml(admin.phone)}" placeholder="请输入联系电话">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div style="display: flex; gap: 12px; justify-content: flex-end;">
                        <a href="${pageContext.request.contextPath}/admin/borrow/apply" class="btn btn-outline">取消</a>
